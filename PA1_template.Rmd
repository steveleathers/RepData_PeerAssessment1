...
```
Mean total number of steps per day: `r mean_raw`

Median total number of steps per day: `r median_raw`
...
These new clean mean is `r mean_clean` steps per day.

And the clean median is `r median_clean` steps per day.
